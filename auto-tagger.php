...
function tagger_sidebar() {
	...
	//]]>
		...
		<fieldset id="autotagger_dbx" class="dbx-box">
			...
			<small style="padding-right: 4px">Auto Tagger will not replace existing tags. For tag suggestions without saving click 'Suggest Tags'.</small>
			<button id="gettags" onclick="tagger_gettags(); return false;" style="width: 95%">Suggest Tags</button>
			</div>
		</fieldset>
	<?php
}
